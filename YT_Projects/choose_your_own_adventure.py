...
if answer == "left":
    ...
    answer = input(
        "You come to a river, you can walk around it os swim accross. Type walk to walk around or swim to swim accross: ")
    ...
    if answer == "back":
        ...
        answer = input(
            "You cross the bridge and meet a stranger. Do you talk do them? (yes/no)").lower()
        if answer == 'yes':
